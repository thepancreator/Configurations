...
#define CONFIG_EXAMPLES_DIR "Monoprice Makerselect V2"
...
#define STRING_CONFIG_H_AUTHOR "(thepancreator)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Gerrison"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 50.66, -45.19, 0 }
...
#define DISABLE_OTHER_EXTRUDERS true  // Keep only the active extruder enabled
